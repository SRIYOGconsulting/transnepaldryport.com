import diverse_modes from '../../assets/img/services/transportation/logo/diverse_modes.svg';
import state_of_the_art_equipment from '../../assets/img/services/transportation/logo/state_of_the_art_equipment.svg';
...
export const TRANSPORTATION_SERVICES = {
    ...
    content: [
        ...
        },
        {
            ...
            logo: state_of_the_art_equipment
        },
        {
        ...
        },
        {
            ...
            logo: exceptional_customer_service
        }
    ],
    conclusion:
